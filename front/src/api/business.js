...
export const getLatestSuppliersAPI = (goodsIds) => request.get('/base/goods/latest-suppliers', { params: { ids: goodsIds.join(',') }, silent: true })
...
export const batchDeletePurchasesAPI = (ids) => request.post('/business/purchases/batch-delete', ids)
...
export const batchDeleteProductionsAPI = (ids) => request.post('/business/production/batch-delete', ids)
...
export const batchDeletePurchaseReturnsAPI = (ids) => request.post('/business/purchase-returns/batch-delete', ids)
...
export const batchDeleteSalesReturnsAPI = (ids) => request.post('/business/sales-returns/batch-delete', ids)
